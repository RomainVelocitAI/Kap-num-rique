...
export const Component = () => {
  ...
  useEffect(() => {
    const initThree = () => {
      ...
      refs.renderer.setClearColor(0x000000, 1); // Black background
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Show scroll sections after initial scroll
      if (scrollY > 100 && !sectionsVisible) {
        setSectionsVisible(true);
      }

      // Animate hero content upward during scroll
      const heroContent = document.querySelector('.hero-content');
      if (heroContent) {
        const translateY = -scrollY * 0.5; // Move up at half the scroll speed
        (heroContent as HTMLElement).style.transform = `translate(-50%, calc(-50% + ${translateY}px))`;
      }
  ...
  return (
    <div ref={containerRef} className="hero-container cosmos-style" style={{ height: `${heroHeight}vh` }}>
      ...
      <div className="scroll-sections" style={{ 
