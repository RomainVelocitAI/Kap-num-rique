...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // styles adaptés pour fond sombre
  ...
  >
    ...
    <div className="p-4">
      <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 transition-all duration-300 lg:group-hover:-translate-y-10">
        <Icon className="h-12 w-12 origin-left transform-gpu text-gray-300 transition-all duration-300 ease-in-out group-hover:scale-75" />
